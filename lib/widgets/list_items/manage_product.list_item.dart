      ...
      [
        ...
        Wrap(
          children: [
            //
            Padding(
              padding: EdgeInsets.only(bottom: 8, right: 6, left: 1, top: 1),
              child: CustomButton(
                loading: isLoading,
                height: 30,
                title: "Edit",
            ...
            Padding(
              ...
              ).w(context.percentWidth * 32).px8(),
            ),
            Padding(
              padding: EdgeInsets.only(bottom: 5, right: 6, left: 1, top: 3),
              child: CustomButton(
                loading: isLoading,
                height: 30,
                title: "Delete".i18n,
                ...
                color: Colors.red,
              ).w(context.percentWidth * 22).px12(),
            ),
          ],
