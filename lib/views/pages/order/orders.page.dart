        ...
        builder: (context, vm, child) {
          return BasePage(
            body: VStack(
              [
                //
                "Orders".i18n.text.xl2.semiBold.make().p20(),
                //order status
                CustomListView(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    //
                    return CustomButton(
                      title: status.toLowerCase().i18n.allWordsCapitilize(),
                      onPressed: () => vm.statusChanged(status),
                      color: status == vm.selectedStatus ? AppColor.primaryColor : Colors.grey[600],
                    );
                  },
                ).h(50).py12(),
