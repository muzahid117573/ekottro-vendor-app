          ...
          body: SafeArea(
            child: VStack(
              [
                ...
                HStack(
                  [
                    "Vendor Details".i18n.text.xl2.semiBold.make().expand(),
                    UiSpacer.horizontalSpace(),
                    CustomButton(
                      title: (vm.vendor?.isOpen ?? false) ? "Open".i18n : "Closed".i18n,
                      color: (vm.vendor?.isOpen ?? false) ? AppColor.openColor: AppColor.closeColor,
